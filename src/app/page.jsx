...
function DashboardCore({ user }) {
  ...
  useEffect(() => {
    const sd = localStorage.getItem('dateFilter');
    const sm = localStorage.getItem('filterMine');
    const sa = localStorage.getItem('filterAssigned');
  ...
  const syncPermission = () => {
    ...
    localStorage.setItem('push-permission', p);
    return p;
  };
